...
import {
    MapPin, Home, Users, Settings, Server, Activity, LogOut, Network, CreditCard, WifiOff, Database, Menu, X, Palette, ClipboardList, Wallet,
...
export default function BottomDock() {
    ...
    const desktopNavItems = [
        ...
        { href: '/reports/financial', icon: Activity, hoverIcon: TrendingUp, label: t('sidebar.reports'), roles: ['admin', 'manager', 'partner', 'staff', 'agent'] },
