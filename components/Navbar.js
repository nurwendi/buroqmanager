...
export default function Navbar() {
    ...
    const settingsItems = [
        ...
        { href: '/nat', icon: Network, label: t('sidebar.nat'), roles: ['superadmin'] },
    ].filter(item => {
        if (userRole === 'editor') {
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 transition-all duration-300 bg-white/10 border-b border-white/20 shadow-xl">
